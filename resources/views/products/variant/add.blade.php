...
<div class="container">
    ...
    <div class="card mx-4">
        ...
        <div class="card-body">
            <form action="{{ route('variant_store', ['id' => $product_id]) }}" method="post"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" name="variant_name" value="{{ old('variant_name') }}" class="form-control"
                            id="variant_name" placeholder="Variant Name" required>
                        @error('variant_name')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="number" name="selling_price" value="{{ old('selling_price') }}"
                            class="form-control" id="selling_price" placeholder="Selling Price" min="0" step="0.01"
                            required>
                        @error('selling_price')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
